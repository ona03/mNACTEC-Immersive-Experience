...
public class Crouch : MonoBehaviour
{
    // Ja no fem servir KeyCode, el nou sistema ho gestiona diferent
    // Per defecte usarem la tecla Left Control
    ...
    void LateUpdate()
    {
        // Verificació de seguretat per al teclat
        if (Keyboard.current == null) return;

        // NOU SISTEMA: Comprovem si la tecla Ctrl Esquerre està premuda
        bool isBtnPressed = Keyboard.current.leftCtrlKey.isPressed;
